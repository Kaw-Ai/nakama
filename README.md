...
This fork ships ready-to-use deployment assets under [`deploy/`](deploy/README.md):
per-environment configuration templates, Kubernetes manifests (migration job,
deployment, services), a GHCR release pipeline, security scanning CI, and
